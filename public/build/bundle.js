...
var app = (function (events, fs, path, util, stream, os, fsevents$1) {
    'use strict';
    ...
    fsevents$1 = fsevents$1 && fsevents$1.hasOwnProperty('default') ? fsevents$1['default'] : fsevents$1;
        ...
        if (stats && stats.isSymbolicLink()) {
          ...
          try {
            ...
            if (entryRealPathStats.isDirectory()) {
              ...
              if (full.startsWith(entryRealPath) && full.substr(len, 1) === path.sep) {
    ...
    const expand = (ast, options = {}) => {
      ...
      let walk = (node, parent = {}) => {
        ...
        if (node.invalid || node.dollar) {
          q.push(append$1(q.pop(), stringify(node, options)));
          return;
        }
    ...
    var binaryExtensions = /*#__PURE__*/Object.freeze({
        __proto__: null
    });

    var require$$0 = getCjsExportFromNamespace(binaryExtensions);
    ...
    */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 10, 1, 129);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file, 11, 14, 166);
    			add_location(p, file, 11, 1, 153);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ chokidar, path, name, console, __dirname });
...
}(events, fs, path, util, stream, os, fsevents$1));
